...
\newcommand{\dcauthorpre}{Herr} %ggf Titel
\newcommand{\dcauthorsurname}{Schack} 
\newcommand{\dcauthorname}{Sebastian} 
\newcommand{\dcauthoradd}{29.10.1991} %geboren am 
\newcommand{\dcauthorno}{6055} %Matrikelnummer

%-Titel und Untertitel / Title and subtitle-----------------------

\newcommand{\dctitle}{Analyse und Neukonzeption eines Kreditorenworkflows auf Basis von Vorgehensmodellen für die Gestaltung von Unternehmensarchitekturen am Beispiel der GLC Glücksburg Consulting AG} 
...
\newcommand{\dcapprovalb}{Dr. Hinrich Schröder} 
\newcommand{\dcapprovalc}{} 

%-Eingabe der Betreuernamen / Name of the advisors ---------------

\newcommand{\dcada}{Peter Weigel}
...
\newcommand{\dcdean}{}
\newcommand{\dcpresident}{Prof. Dr. Plate} %???
...
% ein paar eigene
\newcommand{\firma}{GLC Glücksburg Consulting AG }
